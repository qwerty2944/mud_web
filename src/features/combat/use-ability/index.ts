...
import type { CombatProficiencyType, MagicElement, WeaponType } from "@/entities/proficiency";
import { isWeaponProficiency, WEAPON_ATTACK_TYPE } from "@/entities/proficiency";
